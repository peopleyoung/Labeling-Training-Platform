...
Usage:
    /home/hdzk/.local/bin/python3.12 task.py create "<title>" [--slug <name>] [--assignee <dev>] [--priority P0|P1|P2|P3] [--parent <dir>] [--package <pkg>]
    ...
    /home/hdzk/.local/bin/python3.12 task.py start <dir>                 # Set active task
...
Usage:
  /home/hdzk/.local/bin/python3.12 task.py create <title>                     Create new task directory
  /home/hdzk/.local/bin/python3.12 task.py create <title> --package <pkg>     Create task for a specific package
  /home/hdzk/.local/bin/python3.12 task.py create <title> --parent <dir>      Create task as child of parent
  ...
  /home/hdzk/.local/bin/python3.12 task.py list [--mine] [--status <status>]  List tasks
...
Examples:
  /home/hdzk/.local/bin/python3.12 task.py create "Add login feature" --slug add-login
  /home/hdzk/.local/bin/python3.12 task.py create "Add login feature" --slug add-login --package cli
  /home/hdzk/.local/bin/python3.12 task.py create "Child task" --slug child --parent .trellis/tasks/01-21-parent
