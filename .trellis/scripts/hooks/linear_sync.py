...
Usage (called automatically by task.py hooks):
    /home/hdzk/.local/bin/python3.12 .trellis/scripts/hooks/linear_sync.py create
    /home/hdzk/.local/bin/python3.12 .trellis/scripts/hooks/linear_sync.py start
    /home/hdzk/.local/bin/python3.12 .trellis/scripts/hooks/linear_sync.py archive

Manual usage:
    TASK_JSON_PATH=.trellis/tasks/<name>/task.json /home/hdzk/.local/bin/python3.12 .trellis/scripts/hooks/linear_sync.py sync
