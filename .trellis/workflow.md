...
```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/init_developer.py <your-name>
```
...
```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/get_context.py --mode packages   # list packages / layers
```
...
```bash
# Task lifecycle
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py create "<title>" [--slug <name>] [--parent <dir>]
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py start <name>          # set active task (session-scoped when available)
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py current --source      # show active task and source
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py finish                # clear active task (triggers after_finish hooks)
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py archive <name>        # move to archive/{year-month}/
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py list [--mine] [--status <s>]
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py list-archive

# Code-spec context (injected into implement/check agents via JSONL).
# `implement.jsonl` / `check.jsonl` are seeded on `task create` for sub-agent-capable
# platforms; the AI curates real spec + research entries during planning when needed.
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py add-context <name> <action> <file> <reason>
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py list-context <name> [action]
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py validate <name>

# Task metadata
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py set-branch <name> <branch>
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py set-base-branch <name> <branch>    # PR target
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py set-scope <name> <scope>

# Hierarchy (parent/child)
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py add-subtask <parent> <child>
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py remove-subtask <parent> <child>

# PR creation
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py create-pr [name] [--dry-run]
```

> Run `/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py --help` to see the authoritative, up-to-date list.
...
```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/add_session.py --title "Title" --commit "hash" --summary "Summary"
```

### Context Script

```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/get_context.py                            # full session runtime
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/get_context.py --mode packages            # available packages + spec layers
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/get_context.py --mode phase --step <X.Y>  # detailed guide for a workflow step
```
...
```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/get_context.py --mode phase --step <step>
# e.g. /home/hdzk/.local/bin/python3.12 ./.trellis/scripts/get_context.py --mode phase --step 1.1
```
...
```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py create "<task title>" --slug <name>
```
...
Skip when `/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py current --source` already points to a task.
...
```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py add-context "$TASK_DIR" implement "<path>" "<reason>"
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py add-context "$TASK_DIR" check "<path>" "<reason>"
```
...
```bash
/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/task.py start <task-dir>
```
...
**Final pass (before Phase 3.4 commit)**: the last 2.2 of a task must run full-scope, not just on the latest implement chunk. List all affected packages with `/home/hdzk/.local/bin/python3.12 ./.trellis/scripts/get_context.py --mode packages`, then load each package's spec index Quality Check section. This catches cross-layer / multi-package issues a mid-iteration local 2.2 cannot.
