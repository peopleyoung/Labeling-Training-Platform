...
```bash
/home/hdzk/.local/bin//home/hdzk/.local/bin//home/hdzk/.local/bin//home/hdzk/.local/bin/python3.12.12.12.12 ./.trellis/scripts/get_context.py --mode phase --step <X.X> --platform codex
```
