...
The default `cpu-worker` consumes `forge-cpu` without requiring NVIDIA hardware. YOLOv5u/YOLOv8 detection, YOLOv8-Seg, YOLOv8-Pose, SegFormer/U-Net/DeepLabV3+ segmentation, and HRNet/HigherHRNet keypoint jobs perform real optimization on CPU. CPU conversion supports FP32 ONNX, TorchScript, and OpenVINO. TensorRT remains CUDA-only.
...
- YOLOv8-Seg n/s/m/l/x through the pinned Ultralytics CLI
- YOLOv8-Pose n/s/m/l/x through the pinned Ultralytics CLI
