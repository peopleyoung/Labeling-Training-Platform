...
- SegFormer, U-Net, and DeepLabV3+ through the PyTorch segmentation runner; the RK MobileNetV2 profile uses the RK3588-Plaform `segmentation-models-pytorch` DeepLabV3 graph
