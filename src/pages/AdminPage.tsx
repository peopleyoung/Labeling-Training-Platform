...
import { Check, ChevronDown, FolderTree, KeyRound, Trash2, UserPlus, Users, X } from 'lucide-react';
...
export function AdminPage() {
  ...
  return <div className="page admin-page">
    ...
    <div className="admin-layout">
      ...
      <section className="admin-card admin-catalog-card"><header className="admin-card-header"><div><span className="admin-card-icon"><FolderTree size={18} /></span><div><h2>任务类型目录</h2><p>维护数据中心的大类和业务任务</p></div></div><Link className="button secondary compact" to="/admin/task-catalog">进入目录</Link></header><p className="admin-catalog-description">管理员可以新增、编辑、排序和停用全局任务类型，停用后仍保留历史数据关联。</p></section>
    </div>
