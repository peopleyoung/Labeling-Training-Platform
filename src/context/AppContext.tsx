...
interface AppContextValue {
  ...
  loadAnnotatorPerformance: (filter?: AnnotatorPerformanceFilter) => Promise<AnnotatorPerformance[]>;
  toasts: ToastMessage[];
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const loadAnnotatorPerformance = useCallback(async (filter?: AnnotatorPerformanceFilter) => apiEnabled ? (await client.annotatorPerformance(filter)).items : [], [client]);
